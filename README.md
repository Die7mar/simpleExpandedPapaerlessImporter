...
# ⚖️ Lizenzen der verwendeten Pakete / NuGet Package Licenses

## Paketübersicht / Package Overview

| Paket | Version | Lizenz | Typ |
|-------|---------|--------|-----|
| `QuestPDF` | 2026.2.4 | Community ✅ | Kostenlos für Umsatz < $1M/Jahr |
| `MimeKit` | 4.15.1 | MIT ✅ | Permissiv |
| `Microsoft.EntityFrameworkCore.Sqlite` | 10.0.5 | MIT ✅ | Permissiv |
| `Microsoft.EntityFrameworkCore.Design` | 10.0.5 | MIT ✅ | Permissiv |
| `Microsoft.AspNetCore.Identity` | (built-in) | MIT ✅ | Permissiv |
| `Serilog.AspNetCore` | 10.0.0 | Apache 2.0 ✅ | Permissiv |
| `Serilog.Sinks.File` | 7.0.0 | Apache 2.0 ✅ | Permissiv |

**Keine AGPL-Abhängigkeiten. Keine bekannten CVEs in direkten Abhängigkeiten.**

### QuestPDF Community License

QuestPDF ist kostenlos nutzbar für Projekte mit einem jährlichen Umsatz unter **$1.000.000 USD**. Anforderungen:

- Im Code muss `QuestPDF.Settings.License = LicenseType.Community` gesetzt sein ✅ (bereits implementiert)
- Bei kommerzieller Nutzung über $1M: Professional/Enterprise-Lizenz kaufen

### Apache 2.0 (Serilog)

Permissiv, erlaubt kommerzielle Nutzung. Anforderungen:
- Lizenztext beilegen bei Weitergabe
- Änderungen am Serilog-Code kennzeichnen

Apache 2.0 is permissive and allows commercial use. Requirements:
- Include the license text when distributing
- Mark any changes to the Serilog code

---

## ✅ MIT (MimeKit, EF Core) – Was zu beachten ist

MIT ist die permissivste Lizenz. Du musst lediglich:
- Den Copyright-Hinweis und die Lizenztexte beilegen wenn du die Software weitergibst

MIT is the most permissive license. You only need to:
- Include the copyright notice and license texts when distributing the software
